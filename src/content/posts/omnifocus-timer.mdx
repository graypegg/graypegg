...
* **I can make perspectives that filter for tasks that are started, but I haven't tracked much time on them.**

That's the big one. There are a number of Estimated Duration filters. I took a screenshot here, though sorry for the language change. You have the option (#1) of filtering for only items you've tracked **any** time on, then a range of 4 options (#2, #3, #4, #5) for filtering tasks where you've tracked **under** that amount of time.
