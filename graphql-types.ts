...
export type IconFilesQueryVariables = Exact<{ [key: string]: never; }>;


export type IconFilesQuery = { allFile: { edges: Array<{ node: Pick<File, 'id' | 'name' | 'publicURL'> }> }, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'siteUrl'>> }> };
...
export type LandingPageQuery = { allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'path' | 'icon'>> } }> }, mdx?: Maybe<(
    Pick<Mdx, 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'date'>> }
  )> };

export type PostsPageQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsPageQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'path' | 'date'>> }
      ) }> } };
...
export type BlogPostQuery = { mdx?: Maybe<(
    Pick<Mdx, 'id' | 'body' | 'excerpt'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'icon'>> }
  )> };
